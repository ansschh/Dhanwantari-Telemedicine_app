...
public final class RegulardoctoritemBinding implements ViewBinding {
  @NonNull
  ...
  private RegulardoctoritemBinding(@NonNull CardView rootView, @NonNull Button acceptbutton,
  ...
  @NonNull
  public static RegulardoctoritemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RegulardoctoritemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.regulardoctoritem, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RegulardoctoritemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RegulardoctoritemBinding((CardView) rootView, acceptbutton, address, declinebutton,
