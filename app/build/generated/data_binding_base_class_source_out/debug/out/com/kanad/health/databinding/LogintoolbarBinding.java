...
public final class LogintoolbarBinding implements ViewBinding {
  @NonNull
  ...
  private LogintoolbarBinding(@NonNull RelativeLayout rootView, @NonNull TextView nameontop,
  ...
  @NonNull
  public static LogintoolbarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LogintoolbarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.logintoolbar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LogintoolbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LogintoolbarBinding((RelativeLayout) rootView, nameontop, relativeLayoutProfile);
    }
