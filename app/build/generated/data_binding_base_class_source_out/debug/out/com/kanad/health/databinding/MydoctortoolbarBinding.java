...
public final class MydoctortoolbarBinding implements ViewBinding {
  @NonNull
  ...
  private MydoctortoolbarBinding(@NonNull RelativeLayout rootView, @NonNull ImageView back,
  ...
  @NonNull
  public static MydoctortoolbarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MydoctortoolbarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.mydoctortoolbar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MydoctortoolbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MydoctortoolbarBinding((RelativeLayout) rootView, back, nameontop,
