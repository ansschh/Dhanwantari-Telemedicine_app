...
public final class RegularpatienttoolbarBinding implements ViewBinding {
  @NonNull
  ...
  private RegularpatienttoolbarBinding(@NonNull RelativeLayout rootView, @NonNull ImageView back,
  ...
  @NonNull
  public static RegularpatienttoolbarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RegularpatienttoolbarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.regularpatienttoolbar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RegularpatienttoolbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RegularpatienttoolbarBinding((RelativeLayout) rootView, back, nameontop,
