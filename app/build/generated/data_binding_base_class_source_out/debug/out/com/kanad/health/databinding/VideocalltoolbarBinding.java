...
public final class VideocalltoolbarBinding implements ViewBinding {
  @NonNull
  ...
  private VideocalltoolbarBinding(@NonNull RelativeLayout rootView, @NonNull ImageView back,
  ...
  @NonNull
  public static VideocalltoolbarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static VideocalltoolbarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.videocalltoolbar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static VideocalltoolbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VideocalltoolbarBinding((RelativeLayout) rootView, back, nameontop,
