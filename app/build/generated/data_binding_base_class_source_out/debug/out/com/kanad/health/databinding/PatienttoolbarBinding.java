...
public final class PatienttoolbarBinding implements ViewBinding {
  @NonNull
  ...
  private PatienttoolbarBinding(@NonNull RelativeLayout rootView, @NonNull ImageView back,
  ...
  @NonNull
  public static PatienttoolbarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PatienttoolbarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.patienttoolbar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PatienttoolbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PatienttoolbarBinding((RelativeLayout) rootView, back, nameontop,
