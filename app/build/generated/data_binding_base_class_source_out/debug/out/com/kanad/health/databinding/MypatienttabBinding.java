...
public final class MypatienttabBinding implements ViewBinding {
  @NonNull
  ...
  private MypatienttabBinding(@NonNull CardView rootView, @NonNull TextView DoctorUidDummy,
  ...
  @NonNull
  public static MypatienttabBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MypatienttabBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.mypatienttab, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MypatienttabBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MypatienttabBinding((CardView) rootView, DoctorUidDummy, ageOnList, genderOnList,
