...
public final class ToolbardoctorprofileBinding implements ViewBinding {
  @NonNull
  ...
  private ToolbardoctorprofileBinding(@NonNull RelativeLayout rootView, @NonNull ImageView back,
  ...
  @NonNull
  public static ToolbardoctorprofileBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ToolbardoctorprofileBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.toolbardoctorprofile, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ToolbardoctorprofileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ToolbardoctorprofileBinding((RelativeLayout) rootView, back, nameontop,
