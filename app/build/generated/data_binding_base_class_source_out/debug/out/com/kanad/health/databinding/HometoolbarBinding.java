...
public final class HometoolbarBinding implements ViewBinding {
  ...
  private HometoolbarBinding(@NonNull RelativeLayout rootView, @NonNull TextView nameontop,
  ...
  @NonNull
  public static HometoolbarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static HometoolbarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.hometoolbar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static HometoolbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HometoolbarBinding((RelativeLayout) rootView, nameontop, relativeLayoutProfile);
    }
