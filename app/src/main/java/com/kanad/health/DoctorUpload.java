...
public class DoctorUpload {
    ...
    public String getEshtablishmentType() {
        return EshtablishmentType;
    }

    public void setEshtablishmentType(String eshtablishmentType) {
        EshtablishmentType = eshtablishmentType;
    }
    ...
    public DoctorUpload(String specilization_, String degree_, String institute_, String yearOfCompletetion, String yearsOfExpirience, String eshtablishmentType, String approved, String image_Url, String doctor_Name, String doctor_uid_dummy) {
        Specilization_ = specilization_;
        Degree_ = degree_;
        Institute_ = institute_;
        YearOfCompletetion = yearOfCompletetion;
